            ...
            const fetchItemPromises = receivedProducts.map(product => {
                return fetch(product.url)
                        ...
                        .then(singleItemData => {
                            ...
                            new StockProducts(singleItemData.id, singleItemData.name, singleItemData.cost, singleItemData.sprites.default)
...
class StockProducts {
    ...
    constructor(id, productName, productPrice,img){
        this.id = ++StockProducts.idSetter; // create id secuentially 
        this.publicID = id;
